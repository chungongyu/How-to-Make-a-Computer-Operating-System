...
class Architecture {
 public:
  ...
  void  add_process(Process* p);/* add a process to the scheduler */
  ...
  void  init_process();   /* initialise the list of processes */
  int   create_process(process_st* info, char* file, int argc, char** argv);  /* initialise a process */
